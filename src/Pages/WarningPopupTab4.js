...
import InfoPopupTab4 from "./InfoPopupTab4";

const WarningPopupTab4 = ({ open, close, str, selectedItems }) => {
  const [infoPopupTab4, setInfoPopupTab4] = React.useState(false);
  ...
  const warning =
    ...
    " Odalara " +
    str +
    " Komutu\n  Göndermek İstediğinize Emin Misiniz ?";
  return (
    <>
      <Dialog
      ...
      <InfoPopupTab4
        ...
        open={infoPopupTab4}
        str={str}
        close={() => setInfoPopupTab4(false)}
      />
    </>
  );
};

export default WarningPopupTab4;
